...
const Platform: React.FC = () => {
  return (
    <section id="platform" className="py-24 bg-[#0a0a0a] relative overflow-hidden">
      <div className="absolute inset-0 opacity-5" style={{ backgroundImage: `url('${ASSETS.noise}')` }}></div>
      {/* Electric Blue glow */}
      <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-blue-500/10 rounded-full blur-[150px] pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mb-16 anim-element anim-reveal-text">
          <h2 className="font-display text-5xl md:text-7xl font-bold text-white mb-4 tracking-tight leading-none uppercase">
            THE UUV <br />
            {/* Electric Blue text and glow */}
            <span className="text-blue-400" style={{ textShadow: '0 0 15px rgba(59, 130, 246, 0.7)' }}>PLATFORM</span>
          </h2>
          {/* Electric Blue line and shadow */}
          <div className="h-1 w-32 bg-blue-400 rounded-full mb-8 shadow-[0_0_20px_rgba(59,130,246,0.6)]"></div>
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div className="hidden md:block">
              {/* Electric Blue tag */}
              <span className="font-mono text-blue-300 text-xs tracking-widest uppercase border border-blue-400/30 px-3 py-1 rounded bg-blue-500/10 shadow-[0_0_10px_rgba(59,130,246,0.2)]">
                Flagship Model
              </span>
            </div>
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch mb-24">
          <div className="w-full lg:w-5/12 anim-element anim-scale-subtle">
            {/* Electric Blue border and shadow */}
            <div className="relative h-full min-h-[500px] rounded-3xl overflow-hidden bg-[#0e0e0e] border border-blue-400/20 group shadow-[0_0_30px_rgba(59,130,246,0.1)]">
              <div
                className="absolute inset-0 bg-cover bg-center transition-transform duration-1000 group-hover:scale-105"
                style={{ backgroundImage: `url('${ASSETS.platformAntarleen}')` }}
              ></div>
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent"></div>
              <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-transparent to-black/80"></div>
              <div className="absolute bottom-0 left-0 p-8 w-full z-20">
                {/* Electric Blue border */}
                <div className="backdrop-blur-xl bg-black/30 border border-blue-400/20 p-6 rounded-2xl relative overflow-hidden">
                  {/* Electric Blue pulse and shadow */}
                  <div className="absolute top-0 left-0 w-1 h-full bg-blue-400 animate-pulse shadow-[0_0_10px_rgba(59,130,246,0.8)]"></div>
                  <h3 className="text-3xl font-display font-bold text-white mb-2 tracking-wide" style={{ textShadow: '0 0 10px rgba(59, 130, 246, 0.5)' }}>UNIT: ANTARLEEN-X</h3>
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    {/* Electric Blue text and glow */}
                    <p className="text-blue-300 font-mono text-sm uppercase tracking-widest font-bold" style={{ textShadow: '0 0 8px rgba(59, 130, 246, 0.6)' }}>Status: Operational</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="w-full lg:w-7/12 anim-element anim-slide-left">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-full">
              {[
                ...
                <div key={idx} className="p-8 bg-[#0e0e0e] border border-white/10 rounded-2xl hover:border-blue-400/50 hover:bg-[#141414] transition-all duration-300 group flex flex-col justify-center">
                  <p className="text-xs font-mono text-gray-500 uppercase tracking-widest mb-2 group-hover:text-blue-400">{item.label}</p>
                  <div className="flex items-baseline gap-2">
                    <h4 className="text-5xl font-mono text-white font-bold tracking-tighter" style={{ transition: 'text-shadow 0.3s' }}>{item.value}</h4>
        ...
        <div className="flex flex-col lg:flex-row gap-8 items-stretch">
          <div className="w-full lg:w-5/12 anim-element anim-scale-subtle">
            <div className="relative h-full min-h-[500px] rounded-3xl overflow-hidden bg-[#0e0e0e] border border-secondary/20 group shadow-[0_0_30px_rgba(0,255,255,0.1)]">
              <div 
                className="absolute inset-0 bg-cover bg-center transition-transform duration-1000 group-hover:scale-105"
                style={{ backgroundImage: `url('/assets/cygnus-bg.jpg')` }}
              ></div>
              <div className="absolute inset-0"></div>
              
              <div className="absolute inset-0 flex items-center justify-center">
               {/* Optional: Kept the placeholder box if image fails or for style, remove if you want just image */}
